...
namespace Hotel.Web.Tests
{
    ...
    {
        private DbContextOptions<HotelDbContext> dbContextOptions = new DbContextOptionsBuilder<HotelDbContext>()
        ...
        public void Setup()
        {
            ...
            controller = new ReservationsController(new HotelDbContext(dbContextOptions));
        }

        [Test]
        public async Task Get_FetchesReservationsWithoutRoomsAndGuests()
        {
            using var context = new HotelDbContext(dbContextOptions);
