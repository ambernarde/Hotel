...
namespace Hotel.Web.Migrations
{
    ...
    [Migration("20201004194232_ReservationProfileRelation")]
    partial class ReservationProfileRelation
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hotel.Web.Models.Address", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Hotel.Web.Models.GuestArrival", b =>
                {
            ...
            modelBuilder.Entity("Hotel.Web.Models.RoomOccupied", b =>
                {
                    b.Property<DateTime>("From")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("Hotel.Web.Models.Address", b =>
                {
                    b.HasOne("Hotel.Web.Models.Profile", "Profile")
                        .WithOne("Address")
                        .HasForeignKey("Hotel.Web.Models.Address", "ProfileId")
            ...
            modelBuilder.Entity("ProfileReservation", b =>
                {
                    b.HasOne("Hotel.Web.Models.Profile", null)
                        .WithMany()
